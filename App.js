...
import LoadingScreen from './components/LoadingScreen'; // Ensure this does not contain NavigationContainer
...
export default function App() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsLoading(false); // Hide loading screen after animation
    }, 3000); 
